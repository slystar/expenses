...
describe "Expenses ->" do
	...
	describe "Menu ->" do
		...
		it "should show record count with no records" do
		    # Visit
		    visit "/expenses/process_data"
		    page.should have_content("0 expenses to process")
		    page.should have_content("0 returns to process")
		end

		describe "With existing expense" do
		    before(:each) do
			# Get expense
