...
describe ReturnsController do
  ...
  describe "GET index" do
    it "assigns all returns as @returns" do
      ...
      assigns(:returns).should eq([return])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested return as @return" do
      return = Return.create! valid_attributes
      get :show, {:id => return.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested return as @return" do
      return = Return.create! valid_attributes
      get :edit, {:id => return.to_param}, valid_session
      assigns(:return).should eq(return)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Return" do
        expect {
          post :create, {:return => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved return as @return" do
        ...
        post :create, {:return => {  }}, valid_session
        assigns(:return).should be_a_new(Return)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested return" do
        ...
        put :update, {:id => return.to_param, :return => { "these" => "params" }}, valid_session
      end

      it "assigns the requested return as @return" do
        return = Return.create! valid_attributes
        put :update, {:id => return.to_param, :return => valid_attributes}, valid_session
        assigns(:return).should eq(return)
      end
      ...
      it "redirects to the return" do
        return = Return.create! valid_attributes
        put :update, {:id => return.to_param, :return => valid_attributes}, valid_session
        response.should redirect_to(return)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the return as @return" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Return.any_instance.stub(:save).and_return(false)
        put :update, {:id => return.to_param, :return => {  }}, valid_session
        assigns(:return).should eq(return)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested return" do
      return = Return.create! valid_attributes
      expect {
        delete :destroy, {:id => return.to_param}, valid_session
      }.to change(Return, :count).by(-1)
    end
